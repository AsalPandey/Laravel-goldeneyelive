...
class PublicSettingsCleanupCommandTest extends TestCase
{
    ...
    public function test_real_run_normalizes_stale_site_setting_values(): void
    {
        SiteSetting::insert([
            ...
            ['key' => 'faq_btn_text', 'value' => 'Reveal More Course Questions', 'type' => 'text'],
        ...
        $this->assertDatabaseHas(SiteSetting::class, ['key' => 'faq_btn_text', 'value' => 'Reveal More Course Questions']);
