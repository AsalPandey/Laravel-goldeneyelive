...
class PublicCtaRenderingTest extends TestCase
{
    ...
    public function test_homepage_renders_sales_ctas_and_whatsapp_chat_prompt(): void
    {
        ...
        $this->get(route('home'))
            ...
            ->assertSee('Language, test-preparation, computer and IT classes', false)
            ->assertSee('Practical learning for students and other learners', false)
            ->assertSee('Course guidance for students and parents', false)
            ->assertSee('Visit us at Srijana Chowk, Pokhara', false)
            ...
            ->assertDontSee('Profile role:', false)
            ...
            ->assertSee('FAQ', false)
            ->assertSee('Need help choosing a course?', false)
