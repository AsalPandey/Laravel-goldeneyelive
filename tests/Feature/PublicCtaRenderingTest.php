...
class PublicCtaRenderingTest extends TestCase
{
    ...
    public function test_homepage_renders_sales_ctas_and_whatsapp_chat_prompt(): void
    {
        ...
        $this->get(route('home'))
            ...
            ->assertSee('Clear course information', false)
            ->assertSee('Practical learning connected to student goals', false)
            ->assertSee('Support for students and parents', false)
            ->assertSee('Call or message before planning your visit', false)
            ->assertSee('I am a Student', false)
            ->assertSee('I am a Parent', false)
            ->assertSee('I need IELTS or PTE classes', false)
            ->assertSee('I want Computer or IT Skills', false)
            ->assertSee('Popular course choices', false)
            ->assertSee('Browse by learning area', false)
            ->assertSee('Why Golden Eye Academy', false)
            ->assertSee('Golden Eye faculty', false)
            ->assertSee('Profile role:', false)
            ->assertSee('Matched courses:', false)
            ->assertSee('Profile note:', false)
            ->assertDontSee('Verified external reviews', false)
            ->assertDontSee('verified Google review proof', false)
            ->assertSee('For parents', false)
            ->assertSee('FAQ', false)
            ->assertSee('Ready to find a suitable course?', false)
