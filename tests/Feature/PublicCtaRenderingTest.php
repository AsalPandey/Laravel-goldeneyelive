...
class PublicCtaRenderingTest extends TestCase
{
    ...
    public function test_homepage_renders_sales_ctas_and_whatsapp_chat_prompt(): void
    {
        ...
        $this->get(route('home'))
            ...
            ->assertSee('15+ years of guidance', false)
            ...
            ->assertSee('FAQ', false)
            ->assertSee('Still confused about which course fits you?', false)
