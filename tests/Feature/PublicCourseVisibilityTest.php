...
class PublicCourseVisibilityTest extends TestCase
{
    ...
    public function test_course_detail_page_renders_deep_decision_sections_and_contextual_ctas(): void
    {
        ...
        $teacher = Teacher::where('name', 'Aakash Subedi')->firstOrFail();
        ...
        $response->assertOk()
            ...
            ->assertSee('Prepare for all four IELTS skills', false)
            ->assertDontSee('Best for:', false)
            ->assertSee('Duration: 6 Weeks', false)
            ->assertSee('Fee: Rs. 7,000', false)
            ->assertSee('Class schedule: Ask about current timings', false)
            ->assertSee('Ask for Course Help', false)
            ...
            ->assertSee('Student feedback', false)
            ->assertSee('Course:', false)
            ->assertSee('The IELTS practice and feedback gave me a clear improvement plan', false)
            ->assertDontSee('Verified external reviews', false)
            ->assertDontSee('verified Google review proof', false)
            ->assertSee('FAQs', false)
            ->assertSee('Need help deciding?', false)
