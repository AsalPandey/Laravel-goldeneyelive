...
class PublicCourseVisibilityTest extends TestCase
{
    ...
    public function test_course_detail_page_renders_deep_decision_sections_and_contextual_ctas(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertSee('Published outline', false)
            ->assertSee('Listed learning areas', false)
            ->assertSee('Course outline order', false)
            ->assertSee('Outline item 1', false)
            ...
            ->assertSee('Published student feedback', false)
            ->assertSee('Course listed:', false)
            ->assertSee('Feedback summary:', false)
