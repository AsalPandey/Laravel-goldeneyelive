        ...
        <div class="container">
            <div class="text-center wow fadeInUp mb-8" data-wow-delay="0.1s">
                <div class="d-flex align-items-center justify-content-center gap-3 mb-3">
                    ...
                    <span class="text-brand-gold-accessible font-black uppercase tracking-[0.25em]" style="font-size: 11px;">{{ $settings['pathway_tagline'] ?? 'Course categories' }}</span>
                    <div style="width: 30px; height: 1.5px; background: var(--brand-gold);"></div>
                </div>
                <h2 class="h3 fw-black text-brand-dark uppercase tracking-tighter">Browse By <span class="text-brand-gold-accessible">Goal</span></h2>
            </div>
                            ...
                            <div class="relative overflow-hidden h-64">
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-brand-dark/90 via-brand-dark/30 to-transparent flex flex-column justify-end p-5 text-start">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <span class="text-brand-gold font-black text-[11px] uppercase tracking-[0.2em]">{{ $category->courses_count }} Specializations</span>
    ...
    <div class="container-xxl py-4">
        <div class="container">
            <div class="text-center wow fadeInUp mb-8" data-wow-delay="0.1s">
                <div class="d-flex align-items-center justify-content-center gap-3 mb-3">
                    <div style="width: 30px; height: 1.5px; background: var(--brand-gold);"></div>
                    <span class="text-brand-gold-accessible font-black uppercase tracking-[0.25em]" style="font-size: 11px;">Common choices</span>
                    <div style="width: 30px; height: 1.5px; background: var(--brand-gold);"></div>
                </div>
                <h2 class="h3 fw-black text-brand-dark uppercase tracking-tighter">Our Most <span class="text-brand-gold-accessible">Popular Paths</span></h2>
            </div>
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="premium-card p-0 overflow-hidden h-full flex flex-col border border-zinc-100 shadow-lg rounded-xl">
                            ...
                            <div class="p-5 text-center flex flex-col flex-grow">
                                <div class="mb-4 d-inline-flex align-items-center justify-content-center gap-2 text-brand-dark fw-black text-uppercase tracking-widest" style="font-size: 11px;">
                                ...
                                <div class="mt-auto pt-4 border-top border-zinc-100 d-flex justify-content-center gap-3 mb-2">
                                    <small class="text-brand-dark text-uppercase font-black tracking-widest" style="font-size: 11px;"><i class="fa fa-clock text-brand-gold me-2"></i>{{ $course->duration }}</small>
                                    <small class="text-brand-dark text-uppercase font-black tracking-widest" style="font-size: 11px;"><i class="fa fa-tag text-brand-gold me-2"></i>{{ $course->price }}</small>
                                </div>
                                <div class="d-flex align-items-center justify-content-center gap-2 mb-6 flex-wrap">
                                    <div class="text-center bg-brand-gold/10 rounded-full px-3 py-1 border border-brand-gold/20">
                                        <span class="fw-black text-brand-gold-accessible uppercase tracking-widest" style="font-size: 11px;">Ask for current batch</span>
                                    </div>
                                    <div class="text-center bg-zinc-50 rounded-full px-3 py-1 border border-zinc-100">
                                        <i class="fas fa-comment-dots text-brand-dark me-1" style="font-size: 11px;" aria-hidden="true"></i>
