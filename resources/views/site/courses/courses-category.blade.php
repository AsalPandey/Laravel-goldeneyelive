        ...
        <div class="container py-4">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    ...
                    <p class="text-brand-gold fw-black uppercase tracking-[0.3em] mb-4 animated fadeIn" style="font-size: 10px;">{{ $settings['category_header_badge'] ?? 'Specialized Department' }}</p>
    ...
    <div class="container-xxl py-4">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">{{ $settings['category_tagline'] ?? 'Specialized Training' }}</h6>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="premium-card p-0 overflow-hidden h-full flex flex-col rounded-xl shadow-lg border border-zinc-100">
                            <div class="relative overflow-hidden h-52">
                                ...
                                <span class="position-absolute top-0 start-0 bg-brand-gold text-brand-dark px-2 py-1 m-3 rounded-full text-[8px] font-black uppercase tracking-widest shadow-lg">{{ $course->badge_text ?? 'Professional' }}</span>
                            </div>
                            
                            <div class="p-5 text-center flex flex-col flex-grow">
                                <div class="mb-3 flex justify-center gap-1">
                                    @php
                                        $rating_star = (float)($course->rating_star ?? 5);
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <a href="{{ $course->slug ? route('courses-detail', $course->slug) : route('courses-all') }}" class="btn btn-outline-dark rounded-lg font-black text-uppercase tracking-widest py-2" style="font-size: 9px;">View Career Roadmap</a>
                                    <a href="{{ route('join-now', ['course' => $course->slug]) }}" data-cta="category-course-help" class="btn btn-primary rounded-lg py-2 shadow-lg font-black text-uppercase tracking-widest" style="font-size: 9px;">Ask About This Course</a>
                                </div>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="col-lg-12 text-center py-5">
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-center gap-2 mt-4">
                            <a href="{{ route('join-now') }}" data-cta="category-empty-course-help" class="btn btn-primary px-5 rounded-pill">Ask for Course Help</a>
                            <a href="{{ route('courses') }}" class="btn btn-outline-brand-dark px-5 rounded-pill">Explore Other Departments</a>
                        </div>
                    </div>
                @endforelse
            </div>
