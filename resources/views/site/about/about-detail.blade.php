...
@section('page_title', $settings['meta_title'] ?? 'Our Story - Golden Eye Academy')
@section('meta_description', $settings['meta_description'] ?? 'Learn about the history and mission of Golden Eye Academy in Pokhara.')
@section('content')
    <!-- Header Start -->
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp position-relative" data-wow-delay="0.1s" style="min-height: 300px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100 rounded-xl shadow-lg border-2 border-white" src="{{ \App\Support\PublicAsset::url($settings['about_image'] ?? null, 'site/img/about-details.jpg') }}" alt="About Golden Eye Academy" style="object-fit: cover;">
                    </div>
                </div>
