                        ...
                        <div class="space-y-4">
                            ...
                            <div class="p-4 bg-neutral-50 rounded-xl border border-dashed border-neutral-200">
                                ...
                                <div class="flex gap-2">
                                    <input type="text" name="image_path" id="image_path" value="{{ old('image_path') }}" placeholder="e.g. site/img/carousel-1.png" class="flex-1 rounded-xl border-neutral-200 text-xs h-10 px-4 focus:border-orange-600 focus:ring-0">
