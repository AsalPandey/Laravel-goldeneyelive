    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        <div class="flex items-center justify-between pb-4 border-b border-neutral-100">
            ...
            <div class="flex items-center gap-4">
                <form action="{{ route('admin.submissions.newsletter-display') }}" method="GET" class="relative">
                    <i class="fa fa-search absolute left-4 top-1/2 -translate-y-1/2 text-neutral-400 text-xs"></i>
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search emails..." class="pl-10 pr-4 py-2.5 rounded-xl border-neutral-200 bg-white text-xs w-64 focus:border-orange-500 focus:ring-0">
                </form>
            </div>
        </div>
