                    ...
                    <div>
                        ...
                        <div class="mt-1 flex flex-col gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="text" name="photo_path" value="{{ old('photo_path') }}" placeholder="OR Library Path: site/img/..." class="flex-1 rounded-md border-neutral-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-white h-8 px-3 text-xs">
