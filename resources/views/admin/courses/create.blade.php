            ...
            <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="instructor" value="{{ old('instructor') }}" class="mt-1 block w-full rounded-md border-neutral-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-white h-10 px-3">
                        <p class="mt-1 text-xs text-neutral-500">Used only when no linked faculty profile is selected.</p>
                ...
                <x-seo-aeo-fields :meta-title-max="70" :meta-description-max="500" :meta-keywords-max="500" :aeo-summary-max="500" />
