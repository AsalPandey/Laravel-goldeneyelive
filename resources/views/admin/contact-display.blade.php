                ...
                <div class="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="admin_notes" @readonly(! auth()->user()->hasRole('Admin')) id="modal_notes" rows="3" class="w-full px-4 py-3 rounded-xl border-neutral-100 bg-neutral-50 text-xs font-medium focus:ring-brand-gold focus:border-brand-gold transition-all resize-none" placeholder="Record communication history or next steps..."></textarea>
                        </div>
                    </div>
                </div>
