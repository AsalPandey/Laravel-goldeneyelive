...
class NormalizeBrandCopy extends Command
{
    ...
    private const ExactReplacements = [
        ...
        '15+ years of guidance' => 'Current course information',
        ...
        'Guidance from experienced teachers' => 'Course information from the academy team',
        'Confirm current profile with the academy team' => 'Confirm current faculty details with the academy team',
        ...
        'guidance quality' => 'course information quality',
    ...
    private const ExactWholeValueReplacements = [
        'GoldenEye' => 'Golden Eye',
        'GoldenEye Academy - Career, College, Skills and Test Prep in Pokhara' => 'Golden Eye Academy | Courses and Classes in Pokhara',
        'GoldenEye Academy helps students, parents, study abroad applicants, and job seekers choose practical courses through quick course guidance in Pokhara.' => 'Golden Eye Academy offers IELTS/PTE, Japanese, Korean, English, computer, office, web development, and IT classes in Pokhara, Nepal.',
        'GoldenEye Academy provides course guidance, test preparation, language classes, computer skills, web development, and practical support for learners in Pokhara.' => 'Golden Eye Academy in Pokhara provides IELTS/PTE, Japanese, Korean, English, computer, office, web development, and IT classes.',
        'Choose the right course with clear guidance.' => 'Practical courses and classes in Pokhara.',
        ...
        'Guidance-first learning since 2008' => 'Course information before enrollment',
        'GoldenEye Academy exists for one reason: learners should not waste time, money, or confidence on the wrong course. We help you decide first, then train with structure.' => 'Golden Eye Academy in Pokhara provides classes, course information, and academic support before enrollment.',
        'Course Guidance Before Enrollment' => 'Course Information Before Enrollment',
