...
class BrandingController extends Controller
{
    ...
    const TEXT_KEYS = [
        ...
        'catalogue_badge',
        'catalogue_categories_tagline',
        'catalogue_categories_title',
        'catalogue_courses_tagline',
        'catalogue_courses_title',
        'catalogue_description',
        'catalogue_final_description',
        'catalogue_final_title',
        'catalogue_meta_description',
        'catalogue_meta_title',
        'catalogue_services_tagline',
        'catalogue_services_title',
        'catalogue_title',
        'contact_form_title',
