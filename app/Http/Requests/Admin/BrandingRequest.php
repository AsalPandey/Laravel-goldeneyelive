...
class BrandingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'homepage_social_image_path' => ['nullable', 'string', 'max:255', new PublicMediaPath],
            ...
            'homepage_social_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,svg,webp', "max:{$imageLimit}"],
