...
final class GoldenEyeContentBaseline
{
    ...
    public static function siteSettings(): array
    {
        $settings = [
            ...
            'hero_subtitle' => 'Golden Eye Academy offers language, test-preparation, computer and IT classes in Pokhara. Compare courses or ask our team where to begin.',
            ...
            'courses_subtitle' => 'Explore courses by subject and see what you will learn, how long the course takes and what it costs.',
    ...
    private static function audienceSettings(): array
    {
        $pages = [
            ...
            'study_abroad' => [
                ...
                'meta_description' => 'Explore Golden Eye Academy IELTS, PTE and language classes in Pokhara, with Brilliant Education Pokhara named separately for contextual education-consulting questions.',
