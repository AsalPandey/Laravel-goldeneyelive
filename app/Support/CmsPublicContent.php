    ...
    public static function audiencePages(array $settings): array
    {
        ...
        foreach (self::audienceDefinitions() as $key => $defaults) {
            ...
            $pages[$key] = [
                ...
                'support_tagline' => self::value($settings, "{$prefix}_support_tagline", 'Why Golden Eye Academy helps'),
                'support_title' => self::value($settings, "{$prefix}_support_title", 'Academic support before enrollment'),
                'why' => self::value($settings, "{$prefix}_why", $defaults['why']),
                'proof_tagline' => self::value($settings, "{$prefix}_proof_tagline", 'Trust markers'),
