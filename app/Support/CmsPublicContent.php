...
final class CmsPublicContent
{
    ...
    public static function audienceDefinitions(): array
    {
        return [
            ...
            'study_abroad' => [
                ...
                'proof_tagline' => 'German pathway and local billing',
                'proof' => [
                    'German-language classes are provided by Golden Eye Academy.',
                    'Germany education and study-abroad consulting is handled through Brilliant Education Pokhara.',
                    'Golden Eye Academy Pvt. Ltd. remains the local legal and billing operator.',
                ],
    ...
    public static function homepage(array $settings): array
    {
        ...
        $advantageDefaults = [
            ...
            'IELTS/PTE, language, computer, office, and IT classes',
            'Phone and WhatsApp follow-up: '.self::value($settings, 'site_phone', '061-572599'),
        ];
        $parentDefaults = [
        ...
        return [
            'sections' => $sections,
            'meta_title' => self::value($settings, 'home_meta_title', 'Golden Eye Academy | Established Academy in Pokhara Since 2008'),
            'meta_description' => self::value($settings, 'home_meta_description', 'Established in 2008, Golden Eye Academy offers IELTS/PTE, Japanese, Korean, English, computer, office, web development, and IT classes in Pokhara, Nepal.'),
            ...
            'why_title' => self::value($settings, 'home_why_title', 'Practical classes with academic support'),
            'why_description' => self::value($settings, 'home_why_description', 'Students can prepare with mock tests, practical assignments, instructor feedback, and clear weekly progress where the course requires it.'),
            'why_items_text' => self::value($settings, 'home_why_items', implode("\n", $advantageDefaults)),
            'why_items' => self::lines($settings, 'home_why_items', $advantageDefaults),
            'testimonials_tagline' => self::value($settings, 'home_testimonials_tagline', 'Student results'),
            'testimonials_title' => self::value($settings, 'home_testimonials_title', 'Real students. Practical progress.'),
            'faculty_tagline' => self::value($settings, 'home_faculty_tagline', 'Instructors'),
            'faculty_title' => self::value($settings, 'home_faculty_title', 'Experienced faculty for practical classes'),
            'reviews_tagline' => self::value($settings, 'home_reviews_tagline', 'External social proof'),
            'reviews_title' => self::value($settings, 'home_reviews_title', 'Review proof can be verified before enrollment'),
