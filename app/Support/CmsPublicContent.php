...
final class CmsPublicContent
{
        ...
        return [
            ...
            'job_computer_skills' => [
                ...
                'proof' => [
                    ...
                    'Published course outlines, durations, fees, and instructor information',
    ...
    public static function homepage(array $settings): array
    {
        ...
        return [
            ...
            'testimonials_tagline' => self::value($settings, 'home_testimonials_tagline', 'Published student feedback'),
            'testimonials_title' => self::value($settings, 'home_testimonials_title', 'Feedback linked to listed courses'),
