...
class SiteSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            'aeo_summary' => ['GoldenEye Academy provides course guidance, test preparation, language classes, computer skills, web development, and career support for learners in Pokhara.', 'text'],
            ...
            'hero_badge_text' => ['GoldenEye Academy Launchpad', 'text'],
            'hero_title' => ["Don't just study. Build your competitive edge.", 'text'],
            'hero_hook_headline' => ["Don't just study. Build your competitive edge.", 'text'],
            ...
            'hero_subtitle' => ['Send your goal, get a practical roadmap, and choose the course that fits your timeline, budget, and current level.', 'text'],
            'hero_cta_text' => ['Ask for Course Help', 'text'],
            'hero_cta_1_text' => ['Ask for Course Help', 'text'],
            'hero_cta_2_text' => ['See Courses', 'text'],

            'stat_1_val' => ['15+', 'text'],
            'stat_1_lab' => ['Years of Guidance', 'text'],
            'stat_2_val' => ['5,000+', 'text'],
            'stat_2_lab' => ['Learners Supported', 'text'],
            'stat_3_val' => ['4.9/5', 'text'],
            'stat_3_lab' => ['Student Rating', 'text'],
            ...
            'courses_all_tagline' => ['Expert-Led Training', 'text'],
            ...
            'about_point_1' => ['Quick course roadmap help', 'text'],
            ...
            'about_feat_1_desc' => ['Learners understand the best route before committing to a course.', 'text'],
            ...
            'popup_title' => ['Still deciding? Get your roadmap first.', 'text'],
            ...
            'popup_register_link' => ['/join-now?course=undecided', 'text'],
            'notice_badge_text' => ['Official Update', 'text'],
            'notice_dismiss_text' => ['Dismiss Notice', 'text'],

            'whatsapp_cta_text' => ['Message us on WhatsApp', 'text'],
            'whatsapp_cta_subtext' => ['Casual questions. Quick reply.', 'text'],
            'whatsapp_button_text' => ['Message us on WhatsApp', 'text'],
            'whatsapp_prefill_message' => ['Hi GoldenEye Academy, I have a quick question. Can you help me choose the right course?', 'text'],
            'sticky_cta_text' => ['Ask Now', 'text'],
            'sticky_cta_badge' => ['Quick Help', 'text'],
            'sticky_cta_desc' => ['Text us your goal.', 'text'],
            'inquiry_tab_text' => ['Need Guidance?', 'text'],
            'inquiry_title' => ['Get your course recommendation', 'text'],
            'inquiry_subtitle' => ['Share your goal. We will recommend the right next step within 2 hours.', 'text'],
            ...
            'footer_newsletter_desc' => ['Get course updates, quick reminders, and practical career guidance.', 'text'],

            'career_highlight_1' => ['Guidance before enrollment', 'text'],
            'career_highlight_2' => ['Practical course roadmap', 'text'],
            ...
            'enroll_success_message' => ['Your request has been received. Our team will contact you shortly.', 'text'],
        ];
